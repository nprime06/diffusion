...
def save_logs(run_dir, loss_buffer, step, model, optimizer, fm_config, device, image_shape, latent_shape, images_mean, images_std, vae, num_samples=100, checkpoint=True):
